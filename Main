//******************************************************************************************************************************************************************************************************
// MECCONTROL FIRMWARE
// Version: Arduino/Genuino Uno/Mega 1.3.1
//
// Copyright (C) 2015-2018 Tim Surtell
// www.surtell.com
//
      ...
      for (int intStep = 0; intStep < intNumberOfSteps; intStep++) {
        ...
        if (booStepDirectionClockwise) {
          switch (arrEndValue[strCommandPart[1].toInt()][0]) {
            case B00000110:
              arrEndValue[strCommandPart[1].toInt()][0] = B00000101;
              break;
            case B00000101:
              arrEndValue[strCommandPart[1].toInt()][0] = B00001001;
              break;
            case B00001001:
              arrEndValue[strCommandPart[1].toInt()][0] = B00001010;
              break;
            default:
